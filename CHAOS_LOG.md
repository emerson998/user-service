...
- `2026-07-24T22:23:22.081559+00:00` **chaos** — incidente #1 — NullPointerException em /api/v1/users
- `2026-07-24T22:23:35.860028+00:00` **fix** — incidente #1 resolvido — diagnostico: a causa raiz provavel é que o objeto User está com o atributo name como null, o que está causando um NullPointerException quando se tenta chamar o método trim() nele, como mencionado em varios inciden
- `2026-07-24T22:25:26.949324+00:00` **chaos-toggle** — reintroduz bug real (NPE) em UserMapper.toResponse
- `2026-07-24T22:26:07.287762+00:00` **chaos** — incidente #1 — NullPointerException em /api/v1/users
- `2026-07-24T22:26:20.648349+00:00` **fix** — incidente #1 resolvido — diagnostico: a causa raiz provavel é que o objeto User está com o atributo name como null, o que está causando um NullPointerException quando se tenta chamar o método trim() nele, como mencionado em vários inciden
- `2026-07-24T22:51:29.890202+00:00` **chaos-toggle** — reintroduz bug real (NPE) em UserMapper.toResponse
- `2026-07-24T23:16:11.077485+00:00` **chaos-toggle** — reintroduz bug real (NPE) em UserMapper.toResponse
- `2026-07-24T23:17:16.993945+00:00` **chaos** — incidente #1 — NullPointerException em /api/v1/users
- `2026-07-24T23:17:30.578637+00:00` **fix** — incidente #1 resolvido — diagnostico: a causa raiz provavel é que o objeto User está com o atributo name como null, o que está causando um NullPointerException quando se tenta chamar o método trim() nele, como mencionado em varios inciden
- `2026-07-24T23:23:57.781636+00:00` **chaos-toggle** — reintroduz bug real (NPE) em UserMapper.toResponse
- `2026-07-24T23:24:45.829139+00:00` **chaos** — incidente #1 — NullPointerException em /api/v1/users
- `2026-07-24T23:25:49.020355+00:00` **rollback** — rollback do incidente #1 — reintroduz o estado anterior ao fix (revert de 8ef8706)
- `2026-07-24T23:26:35.257587+00:00` **chaos** — incidente #14 — NullPointerException em /api/v1/users
- `2026-07-24T23:26:47.630873+00:00` **fix** — incidente #14 resolvido — diagnostico: a causa raiz provavel é que o objeto User está com o atributo name como null, o que está causando um NullPointerException quando se tenta chamar o método trim() nele, como mencionado em varios inciden
- `2026-07-24T23:29:25.518669+00:00` **chaos-toggle** — reintroduz bug real (NPE) em UserMapper.toResponse
- `2026-07-24T23:30:35.990968+00:00` **chaos** — incidente #1 — NullPointerException em /api/v1/users
- `2026-07-24T23:30:49.689056+00:00` **fix** — incidente #1 resolvido — diagnostico: a causa raiz provavel é que o objeto User está com o atributo name como null, o que está causando um NullPointerException quando se tenta chamar o método trim() nele, como mencionado em vários inciden
- `2026-07-24T23:31:53.992368+00:00` **chaos-toggle** — reintroduz bug real (NPE) em UserMapper.toResponse
- `2026-07-24T23:32:21.218675+00:00` **chaos** — incidente #15 — NullPointerException em /api/v1/users
- `2026-07-24T23:32:35.134337+00:00` **fix** — incidente #15 resolvido — diagnostico: a causa raiz provavel é que o objeto User está com o atributo name como null, o que está causando um NullPointerException quando se tenta chamar o método trim() nele, como mencionado em varios inciden
- `2026-07-24T23:33:58.242798+00:00` **chaos-toggle** — reintroduz bug real (NPE) em UserMapper.toResponse
- `2026-07-24T23:34:27.919981+00:00` **chaos** — incidente #1 — NullPointerException em /api/v1/users
- `2026-07-24T23:34:41.612033+00:00` **fix** — incidente #1 resolvido — diagnostico: a causa raiz provavel é que o objeto User está com o atributo name como null, o que está causando um NullPointerException quando se tenta chamar o método trim() nele, como mencionado em varios inciden
- `2026-07-24T23:47:55.753237+00:00` **chaos-toggle** — reintroduz bug real (NPE) em UserMapper.toResponse
- `2026-07-24T23:48:32.966971+00:00` **chaos** — incidente #1 — NullPointerException em /api/v1/users
- `2026-07-24T23:48:47.099436+00:00` **fix** — incidente #1 resolvido — diagnostico: a causa raiz provavel é que o objeto User está com o atributo name como null, o que está causando um NullPointerException quando se tenta chamar o método trim() nele, como mencionado em varios inciden
- `2026-07-24T23:50:54.919163+00:00` **chaos-toggle** — reintroduz bug real (NPE) em UserMapper.toResponse
