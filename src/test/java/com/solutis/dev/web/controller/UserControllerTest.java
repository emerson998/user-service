...
class UserControllerTest {
    ...
    void create_shouldReturn201_whenRequestIsValid() throws Exception {
        ...
        UserResponse response = new UserResponse(1L, "Alice", "alice@example.com", null, null, true);
    ...
    void create_shouldReturn400_whenNameIsBlank() throws Exception {
        UserRequest request = new UserRequest("", "alice@example.com", "password123", null, null);
