...
- [ ] [18 — API Versioning](18-api-versioning.md) — expor as rotas com prefixo de versão (ex.: `/v1/users`).
- [ ] [19 — Upsert Endpoint](19-upsert-endpoint.md) — endpoint que atualiza o usuário se existir, ou cria um novo se não existir.
...
- [ ] [24 — CSV Export Endpoint](24-csv-export-endpoint.md) — endpoint para exportar usuários para CSV.
...
- [ ] [33 — Basic Login Endpoint](33-basic-login-endpoint.md) — login recebendo um id de usuário e devolvendo um token UUID válido.
