...
- [x] [42 — Database Fallback](42-database-fallback.md) — conexão secundária de fallback caso a instância principal (PostgreSQL) fique indisponível.
